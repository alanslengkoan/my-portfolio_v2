            ...
            <div class="flex items-center">
              <div class="">
                ...
                <div class="flex justify-center sm:block">
                  <a download="Alan-Saputra-Lengkoan-CV.pdf" href="./../assets/doc/CV-Alan-Saputra-Lengkoan-(2022).pdf" class="flex justify-center items-center bg-background-tertiary hover:bg-gray-700 text-white font-bold py-2 px-2 w-36 sm:w-48 mt-10 mb-6 sm:mb-0 rounded shadow-lg duration-500">
